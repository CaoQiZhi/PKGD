...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', '-a', default='resnet20', choices=['resnet8', 'resnet14', 'resnet20', 'resnet32', 'resnet44', 'resnet56', 'resnet110',
    ...
    parser.add_argument('--teacher', type=str, default='resnet56',
                        help='teacher model', choices=['resnet8', 'resnet14', 'resnet20', 'resnet32', 'resnet44', 'resnet56', 'resnet110',
                                 ...
                                 'vgg8', 'vgg11', 'vgg13', 'vgg16', 'vgg19',
                                 'MobileNetV2', 'ShuffleV1', 'ShuffleV2', 'ResNet50'])
    parser.add_argument('--teacher-weight', type=str, default='checkpoints/cifar100_resnet56__best.pt',
    ...
    from model.Fuseblock import Confuse
    ...
    if teacher is not None:
        ...
        # Fuse = Confuse(args.model, teacher=args.teacher)
    ...
    for epoch in range(args.epochs):
        ...
        for i, (images, labels) in enumerate(train_loader):
            ...
            if teacher is not None:
                ...
                # for idx, (input_s, input_t, confuse) in enumerate(zip(s_features, t_features)):
                #     s_features[idx] = confuse(input_s, input_t)
                s_features = Confuse(s_features, t_features)
