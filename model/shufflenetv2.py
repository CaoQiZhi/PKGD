...
class ShuffleNetV2(nn.Module):
    def __init__(self, net_size, num_classes=10):
        ...
        self.coordatten1 = CoordAtt(out_channels[0], out_channels[0])
        self.coordatten2 = CoordAtt(out_channels[1], out_channels[1])
        self.coordatten3 = CoordAtt(out_channels[2], out_channels[2])
