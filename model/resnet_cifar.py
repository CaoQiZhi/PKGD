...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, num_filters, block_name='BasicBlock', num_classes=10):
        ...
        self.coordatten0 = CoordAtt(num_filters[0], num_filters[0])
        self.coordatten1 = CoordAtt(num_filters[1], num_filters[1])
        self.coordatten2 = CoordAtt(num_filters[2], num_filters[2])
        self.coordatten3 = CoordAtt(num_filters[3], num_filters[3])
...
def build_resnet_backbone(depth=20, num_classes = 10):
    if depth == 8:
        ...
        return resnet14(num_classes=num_classes)
    elif depth == 20:
